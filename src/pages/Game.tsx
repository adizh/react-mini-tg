...
function Game() {
  useEffect(()=>{
   Racer.Utils.init()
   Racer.Utils.drawPoint()
   Racer.Utils.drawLine()
   Racer.Utils.getTransform()
  },[])
  return <div>
    
    <svg version="1.1" id="track" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px"
     y="0px"
     viewBox="0 0 900 420" enableBackground="new 0 0 900 420" xmlSpace="preserve">
    <path id="circuit" fill="none" stroke="#000000" strokeWidth="7" d="
